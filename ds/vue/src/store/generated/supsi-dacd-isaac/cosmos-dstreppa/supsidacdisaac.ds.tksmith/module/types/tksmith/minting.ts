...
const baseMinting: object = { index: "", timestamp: 0, amount: 0, creator: "" };

export const Minting = {
  encode(message: Minting, writer: Writer = Writer.create()): Writer {
    if (message.index !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): Minting {
    ...
    const message = { ...baseMinting } as Minting;
