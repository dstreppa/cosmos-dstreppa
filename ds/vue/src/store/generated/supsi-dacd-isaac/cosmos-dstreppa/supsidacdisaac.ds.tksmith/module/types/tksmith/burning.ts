...
const baseBurning: object = { index: "", timestamp: 0, amount: 0, creator: "" };

export const Burning = {
  encode(message: Burning, writer: Writer = Writer.create()): Writer {
    if (message.index !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): Burning {
    ...
    const message = { ...baseBurning } as Burning;
